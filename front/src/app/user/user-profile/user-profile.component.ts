...
export class UserProfileComponent implements OnInit {
  ...
  getUserIntegrations() {
    ...
    // console.log(this.generalService.URL + `IntegrationSettings/GetByEmail/${this.authService.currentUserValue.email}`);

    // tslint:disable-next-line:max-line-length
    // this.httpClient.get<IIntegrationSettings>(this.generalService.URL + `IntegrationSettings/GetByEmail/${this.authService.currentUserValue.email}`, {headers}).subscribe( data => {
    //   console.log(data);
